...
func (_m *UserRepository) CreateUser(user *model.User) (*model.User, *error.Error) {
	ret := _m.Called(user)
...
func (_m *UserRepository) DeleteUser(userID string) *error.Error {
...
func (_m *UserRepository) GetAllUser() ([]model.User, *error.Error) {
	ret := _m.Called()
...
func (_m *UserRepository) GetUserByID(userID string) (*model.User, *error.Error) {
	ret := _m.Called(userID)
...
func (_m *UserRepository) UpdateUserByID(userID string, user *model.User) (*model.User, *error.Error) {

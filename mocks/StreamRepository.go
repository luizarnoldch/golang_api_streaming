...
func (_m *StreamRepository) CreateStream(_a0 *model.Stream) (*model.Stream, error) {
	ret := _m.Called(_a0)
...
func (_m *StreamRepository) GetStreamById(_a0 string) (*model.Stream, error) {
	ret := _m.Called(_a0)
	...
	var r0 *model.Stream
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*model.Stream, error)); ok {
		return rf(_a0)
	}
